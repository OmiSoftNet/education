...
3) [Programming language basics with examples](https://www.youtube.com/c/LearnProgrammingTogether/playlists) (rus)
...
9) [Відеокурс] [Уроки Java для начинающих](https://www.youtube.com/playlist?list=PL0lO_mIqDDFW2xXiWSfjT7hEdOUZHVNbK) (rus)
...
6) [Відео] [Як написати резюме](https://www.youtube.com/watch?v=60mtmWeypVQ) (ukr)
